...
I add the TabNine autocompletion framework too, for some private AI goodness. Not sure if I managed it.
...
I set the spelling dictionary to default to =en_US= while coding, but when writing I manually run =ispell-change-dictionary= to set it to =en_GB=
...
In order to have fun with AI and refactor some code, and see how new languages might be used...let's add GPT

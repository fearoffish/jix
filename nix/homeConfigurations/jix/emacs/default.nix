...
in {
  ...
  #   (("doom" . ((user-emacs-directory . "${doomDir}")
  #               (server-name . "doom")
  ...
  #     exec ${emacsPkg}/bin/emacs --with-profile doom --daemon "''${@}"
  #   '')
  ...
  #     if [[ $socket_file == "" ]]; then
  #         exec ${emacsPkg}/bin/emacs --with-profile doom "''${@}"
  #     else
  #         exec ${emacsPkg}/bin/emacsclient --with-profile doom -n "''${@}"
  #     fi
  #   '')
